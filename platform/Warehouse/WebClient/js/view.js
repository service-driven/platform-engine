...
let View = {
    ...
    setStartPos: function (gridX, gridY) {
        ...
        if (!this.startNode) {
            ...
            this.startNode.attr({x: coord[0], y: coord[1]}).animate(this.nodeStyle.start, 1000);
        }
    },
    setEndPos: function (gridX, gridY) {
        ...
        if (!this.endNode) {
            ...
            this.endNode.attr({x: coord[0], y: coord[1]}).animate(this.nodeStyle.end, 1000);
        }
    },
    addStoragePos: function (gridX, gridY) {
        var coord = this.toPageCoordinate(gridX, gridY);
        this.endNode = this.paper.rect(
            coord[0],
            coord[1],
            ...
            .attr(this.nodeStyle.normal)
            .animate(this.nodeStyle.failed, 1000);
    },
    /**
