...
/**
 * Class EventMessageRestControllerFactory
 *
 * PHP Version 5
 *
 * @category  PHP
 ...
 */
class EventMessageRestControllerFactory implements FactoryInterface
{
    /**
     * Create service
     *
     ...
     *
     * @return EventMessageRestController
     */
    public function createService(ServiceLocatorInterface $controllerManager)
    {
        ...
        $eventSubscriberRestController = new EventMessageRestController();
